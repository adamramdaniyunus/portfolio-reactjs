		...
		<>
			...
			<div className="lg:flex justify-around grid mb-[10rem]">
				<div className="lg:w-96 w-full px-4">
					<img src="assets/headphone.png" className="" alt="good" />
					<h1 className="text-third mt-6 font-bold text-5xl flex items-center">About <span className="text-secondary">Me</span><img src="assets/lampu.png" alt="good" /></h1>
